...
extern "C"
{
    ...
    static inline void ssd_prefill_blackwell_d64_n128_Kernel_Module_Load(
        ssd_prefill_blackwell_d64_n128_Kernel_Module_t* module)
    {
    ...
    static inline void ssd_prefill_blackwell_d64_n128_Kernel_Module_Unload(
        ssd_prefill_blackwell_d64_n128_Kernel_Module_t* module)
    {
...
typedef struct
{
    void* data;
    int32_t dynamic_shapes[1];
} ssd_prefill_blackwell_d64_n128_Tensor_Dvec_t;
...
} ssd_prefill_blackwell_d64_n128_Tensor_seq_idx_t;

typedef struct
{
    void* data;
    int32_t dynamic_shapes[1];
} ssd_prefill_blackwell_d64_n128_Tensor_chunk_indices_t;

typedef struct
{
    void* data;
    int32_t dynamic_shapes[1];
} ssd_prefill_blackwell_d64_n128_Tensor_chunk_offsets_t;

typedef struct
{
    void* data;
    int32_t dynamic_shapes[1];
} ssd_prefill_blackwell_d64_n128_Tensor_seq_chunk_cumsum_t;

typedef struct
{
    void* data;
    int32_t dynamic_shapes[1];
} ssd_prefill_blackwell_d64_n128_Tensor_valid_lens_t;

#ifdef __cplusplus
extern "C"
#endif
    void
    _mlir_ssd_prefill_blackwell_d64_n128__mlir_ciface_cutlass_ssd_blackwell_aot_Tensorgmemoi64i64i641_Tensorgmemoi64i641_Tensorgmemo1_Tensorgmemoi64i64i641_Tensorgmemoi64i64i641_Tensorgmemo1_Tensorgmemo1_Tensorgmemoi64i64i641_Tensorgm(
        void** args, int32_t num_args);

static inline int32_t cute_dsl_ssd_prefill_blackwell_d64_n128_wrapper(
    ssd_prefill_blackwell_d64_n128_Kernel_Module_t* module, ssd_prefill_blackwell_d64_n128_Tensor_x_t* x,
    ssd_prefill_blackwell_d64_n128_Tensor_dt_in_t* dt_in, ssd_prefill_blackwell_d64_n128_Tensor_A_t* A,
    ssd_prefill_blackwell_d64_n128_Tensor_B_t* B, ssd_prefill_blackwell_d64_n128_Tensor_C_t* C,
    ssd_prefill_blackwell_d64_n128_Tensor_Dvec_t* Dvec, ssd_prefill_blackwell_d64_n128_Tensor_dt_bias_t* dt_bias,
    ssd_prefill_blackwell_d64_n128_Tensor_output_t* output, ssd_prefill_blackwell_d64_n128_Tensor_state_t* state,
    ssd_prefill_blackwell_d64_n128_Tensor_dA_cumsum_t* dA_cumsum,
    ssd_prefill_blackwell_d64_n128_Tensor_dt_proc_t* dt_proc, ssd_prefill_blackwell_d64_n128_Tensor_y_ws_t* y_ws,
    ssd_prefill_blackwell_d64_n128_Tensor_seq_idx_t* seq_idx,
    ssd_prefill_blackwell_d64_n128_Tensor_chunk_indices_t* chunk_indices,
    ssd_prefill_blackwell_d64_n128_Tensor_chunk_offsets_t* chunk_offsets,
    ssd_prefill_blackwell_d64_n128_Tensor_seq_chunk_cumsum_t* seq_chunk_cumsum,
    ssd_prefill_blackwell_d64_n128_Tensor_valid_lens_t* valid_lens, int32_t seq_len_val, int32_t nchunks_val,
