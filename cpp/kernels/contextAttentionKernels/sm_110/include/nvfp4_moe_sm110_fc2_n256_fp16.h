...
} nvfp4_moe_sm110_fc2_n256_fp16_Kernel_Module_t;

#ifdef __cplusplus
extern "C"
{
#endif
    void _mlir_nvfp4_moe_sm110_fc2_n256_fp16_cuda_init(void**);
    void _mlir_nvfp4_moe_sm110_fc2_n256_fp16_cuda_load_to_device(void**);
    static inline void nvfp4_moe_sm110_fc2_n256_fp16_Kernel_Module_Load(
        nvfp4_moe_sm110_fc2_n256_fp16_Kernel_Module_t* module)
    {
        ...
        _mlir_nvfp4_moe_sm110_fc2_n256_fp16_cuda_init((void**) (&initArgs));
        ...
        {
            device_id = i;
            _mlir_nvfp4_moe_sm110_fc2_n256_fp16_cuda_load_to_device((void**) (&loadArgs));
            CUTE_DSL_CUDA_ERROR_CHECK(ret);
        }
    }

    static inline void nvfp4_moe_sm110_fc2_n256_fp16_Kernel_Module_Unload(
        nvfp4_moe_sm110_fc2_n256_fp16_Kernel_Module_t* module)
    {
...
#endif
    void
    _mlir_nvfp4_moe_sm110_fc2_n256_fp16__mlir_ciface_cutlass_single_b_wrapper_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_Ptrgmem_16384_256_128_128_128_8_128_16_20_CUstream0x0(
        void** args, int32_t num_args);

static inline int32_t cute_dsl_nvfp4_moe_sm110_fc2_n256_fp16_wrapper(
    nvfp4_moe_sm110_fc2_n256_fp16_Kernel_Module_t* module, void* a_ptr, void* b_ptr, void* a_sf_ptr, void* b_sf_ptr,
