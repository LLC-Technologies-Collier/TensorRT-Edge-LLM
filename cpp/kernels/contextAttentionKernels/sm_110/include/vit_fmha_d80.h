...
#endif
    void
    _mlir_vit_fmha_d80__mlir_ciface_cutlass___call_vit_____main__BlackwellFusedMultiHeadAttentionForward_object_at__Tensorgmemoi64i641_Tensorgmemoi64i641_Tensorgmemoi64i641_Tensorgmemoi64i641_Tensorgmemo1__0161298209(
        void** args, int32_t num_args);

static inline int32_t cute_dsl_vit_fmha_d80_wrapper(vit_fmha_d80_Kernel_Module_t* module,
    vit_fmha_d80_Tensor_q_tensor_t* q_tensor, vit_fmha_d80_Tensor_k_tensor_t* k_tensor,
    vit_fmha_d80_Tensor_v_tensor_t* v_tensor, vit_fmha_d80_Tensor_o_tensor_t* o_tensor,
    vit_fmha_d80_Tensor_cu_seqlens_t* cu_seqlens, int32_t max_seqlen, float scale_softmax_log2, float scale_softmax,
